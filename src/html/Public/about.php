...
<body>
        ...
        <div>
            <nav class="navbar navbar-light navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav " style="margin-top:-13%;margin-left: 13%;">
                        ...
                        <a href="../Public/login.php"><button class="btn btn-primary" id="login">Login</button></a>
    ...
    <article>
        <p style="font-size: 18px;">
            <b>Pick-A-Book</b> is an online E-Bookstore that sells books online. We sell ebooks direct to consumers via PickABook.com. You can read our ebooks online, or download them to a vast array of devices, using our Ebook Reader apps.
            <br><br>

            <b style="font-size: 25px;">Ebook Processing Platform</b><br> Publishers upload 500 ebooks to us every month. Our production unit has been enhanced and modified steadily since April 2021, and has evolved along with the industry. It deals elegantly
            with all the complexities thrown up by an evolving sector, including faulty files and metadata supplied by publishers.

            <br><br>
            <b style="font-size: 25px;">The TEAM</b><br> Deep, broad, detailed domain expertise. The company comprises a small, team of long-time ebook specialists. It’s fair to say that our team knows pretty much everything about processing, managing
            and securely delivering ebooks to a global audience.
    </article><br><br>
