    ...
    <div id="body" class="container"><br>
        <div class="screen">
            <div class="screen-header">
                <h4 style="font-family: Georgia, 'Times New Roman', Times, serif;">Pick-A-Book</h4>
            ...
            <div class="screen-body">
                <div class="screen-body-item left">
                    ...
                    <div class="container_cons">
                        <h2 style="text-align: center;color: aliceblue;">How Can We Help?</h2>
                        <p>We want to hear from you. Please feel free to email or call us. You can also just speak your mind through sending us directly with your message. Fill in the contact form. </p>
                    </div>
                    <div class="app-contact">
                        <h6><i class="material-icons" style="font-size:25px;color:rgb(223, 29, 110)">pin_drop</i>&nbsp;&nbsp;&nbsp;Talamban, Cebu City</h6>

                        <h6> <i class="material-icons" style="font-size:25px;color:rgb(223, 29, 110);">local_phone</i>&nbsp;&nbsp;&nbsp;+63952321459
                        </h6>
                        <h6><i class="material-icons" style="font-size:25px;color:rgb(223, 29, 110)">local_post_office</i>&nbsp;&nbsp;&nbsp;pickabook@gmail.com
                        </h6>
